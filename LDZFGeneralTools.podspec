...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhuyuhui434@gmail.com/LDZFGeneralTools'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhuyuhui434@gmail.com' => 'zhuyuhui434@gmail.com' }
  s.source           = { :git => 'https://github.com/zhuyuhui434@gmail.com/LDZFGeneralTools.git', :tag => s.version.to_s }
  ...
  s.subspec 'DeviceInfo' do |ss|
    ss.source_files = 'LDZFGeneralTools/**/DeviceInfo/*.{h,m}'
  end
